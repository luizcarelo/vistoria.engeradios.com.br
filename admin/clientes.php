...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['acao']) && $_POST['acao'] == 'adicionar') {
    ...
    if (!empty($nome)) {
        $stmt = $conn->prepare("INSERT INTO clientes (nome, endereco, telefone, email) VALUES (?, ?, ?, ?)");
...
if (isset($_GET['desativar'])) {
    ...
    $conn->query("UPDATE clientes SET ativo = 0 WHERE id = $id");
...
if (isset($_GET['ativar'])) {
    ...
    $conn->query("UPDATE clientes SET ativo = 1 WHERE id = $id");
...
<head>
    ...
    <title>Gerenciar Clientes - ENGERADIOS</title>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge <?php echo $cliente['ativo'] ? 'ativo' : 'inativo'; ?>">
